...
const SexualAbuse = () => {
  return (
    <div className="pt-[154px] pb-[62px]">
            ...
            {sexualAbuse.map((value, index) => {
              return (
                <SwiperSlide key={index}>
                  <div
                    className={`py-11 px-7 bg-cover bg-no-repeat ${value.background}`}
                  >
                    <div className="opacity-0 active_slide duration-300">
                      <h3 className="font-georgia font-bold text-xl text-white text-center max-w-[528px] pb-4 mx-auto">
                        Nationally Recognized for Representing Sexual Abuse
                        Survivors
                      </h3>
                      <p className="font-georgia font-normal text-base text-white text-center pb-4">
