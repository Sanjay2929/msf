  ...
  return (
    <div className="container xl:max-w-[1140px] px-3 xl:px-0 mx-auto flex lg:flex-row flex-col-reverse items-center lg:items-start relative z-10">
      <div className="lg:w-1/2 lg:pt-0 pt-8">
        <h1 className="font-georgia font-normal md:text-xl text-lg text-darkBlack tracking-[6px] pb-3 lg:text-start text-center">
          Representation for
        </h1>
      ...
      <div className="lg:w-1/2 lg:ps-6 max-w-[542px]">
        <Image
          className="w-full"
          width={542}
          height={753}
