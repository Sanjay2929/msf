...
const AllLiableParties = () => {
  return (
    <div className="container xl:max-w-[1140px] px-3 xl:px-0 mx-auto flex lg:flex-row flex-col lg:items-end xl:mt-[-180px] lg:-mt-12 pb-[85px] items-center relative z-10">
      ...
      <div className="lg:w-1/2 xl:ps-14 lg:ps-6 pt-8 lg:pt-0">
        ...
        <ul className="flex gap-4 flex-col experience_list pb-7 max-w-[546px] mx-auto">
